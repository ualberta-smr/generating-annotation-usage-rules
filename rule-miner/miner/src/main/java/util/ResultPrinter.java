...
public class ResultPrinter {
    ...
    public void printHeader() {
        ...
        System.out.println("Dataset dir    : " + Configuration.properties.targetProjectsDir());
        System.out.println("Target APIs    : " + Configuration.properties.api().prefixes().toString());
