...
export default class RulepadGrammarListener extends antlr4.tree.ParseTreeListener {
	...
	exitFunctionParameterCondition(ctx) {
	}
	...
	exitDeclarationStatementCondition(ctx) {
	}
	...
	exitConfigurationProperties(ctx) {
	}
	...
	// Exit a parse tree produced by RulepadGrammarParser#beans.
	exitBeans(ctx) {
	}
