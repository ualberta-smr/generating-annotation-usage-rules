...
This shortcut should only be used to specify different annotations from the same package and not with combination of multiple packages (e.g., avoid doing something like `"a.b.[c.[X|Y]|M|N]"`) 
