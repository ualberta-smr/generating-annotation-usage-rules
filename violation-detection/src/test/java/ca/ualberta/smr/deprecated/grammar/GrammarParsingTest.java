package ca.ualberta.smr.deprecated.grammar;

import ca.ualberta.grammar.RulepadGrammarLexer;
import ca.ualberta.grammar.RulepadGrammarParser;
import ca.ualberta.smr.deprecated.DefaultRulePadGrammarListener;
...
import static ca.ualberta.smr.deprecated.model.javaelements.Annotation.annotation;
import static ca.ualberta.smr.deprecated.model.javaelements.Condition.*;
...
public class GrammarParsingTest {
    ...
    private static StaticAnalysisRule getRule_annotation_with_parameter_both_type_and_name() {
        ...
        return new StaticAnalysisRule("annotation_with_parameter_both_type_and_name", single(antecedent), consequent,
